...
const bucin = () => new Promise((resolve, reject) => {
    console.log('Getting random bucin...')
    fetchJson('https://api-neraka.vercel.app/api/bucin')
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
/**
 * Get random quotes anime.
 * @returns {Promise<object>}
 */
const quotesnime = () => new Promise((resolve, reject) => {
    console.log('Getting random quotes anime...')
    fetchJson('https://videfikri.com/api/anime/randomquoteanime')
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const pantun = () => new Promise((resolve, reject) => {
    console.log('Getting random pantun...')
...
const artinama = (query) => new Promise((resolve, reject) => {
    console.log(`Getting Arti Nama ${query} ...`)
    fetchJson(`https://api.vhtear.com/artinama?nama=${query}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})

/**
 * Get chord guitar from title or chord guitar of the song itself.
 * @param {string} query
 * @returns {Promise<object>}
 */
const chord = (query) => new Promise((resolve, reject) => {
    console.log(`Searching chord guitar for ${query}...`)
    fetchJson(`https://api.vhtear.com/chordguitar?query=${query}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const wiki = (query) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/wikipedia?query=${query}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
/**
 * Get Brainly Indonesian .
 * @param {string} query
 * @returns {Promise<object>}
 */
const brainly = (query) => new Promise((resolve, reject) => {
    console.log(`Searching definition for ${query} in Brainly...`)
 ...
 * @returns {Promise<object>}
 */
const gay = () => new Promise((resolve, reject) => {
    console.log('Get persen gay...')
    fetchJson('https://arugaz.herokuapp.com/api/howgay')
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const igStalk = (username) => new Promise((resolve, reject) => {
    ...
    fetchJson(`https://api.vhtear.com/igprofile?query=${username}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
 ...
 * @returns {Promise<object>}
 */
const tktstalk = (username) => new Promise((resolve, reject) => {
    console.log(`Searching account for ${username}`)
    fetchJson(`http://lolhuman.herokuapp.com/api/stalktiktok/${username}?apikey=${config.lol}}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const getSurah = (surah) => new Promise((resolve, reject) => {
    ...
    fetchJson(`http://lolhuman.herokuapp.com/api/quran/${surah}?apikey=${config.lol}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
 ...
 * @returns {Promise<object>}
 */
const ayat = (surah, ayat) => new Promise((resolve, reject) => {
    console.log(`Getting Al-Qur'an surah ${surah} Ayat ${ayat}...`)
    fetchJson(`https://lolhuman.herokuapp.com/api/quran/${surah}/${ayat}?apikey=${config.lol}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
 ...
 * @returns {Promise<object>}
 */
const music = (query) => new Promise((resolve, reject) => {
 ...
 * @returns {Promise<object>}
 */
const xxx = (title) => new Promise((resolve, reject) => {
    console.log(`Searching for Movie ${title}...`)
    fetchJson(`https://api.vhtear.com/xxxsearch?query=${title}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
 ...
 * @returns {Promise<object>}
 */
const xtube = (url) => new Promise((resolve, reject) => {
    console.log(`Download videos XXX from ${url}...`)
 ...
 * @returns {Promise<object>}
 */
const trendingTwt = (country) => new Promise((resolve, reject) => {
    console.log('Get Twitter trending...')
    fetchJson(`https://api.vhtear.com/cekongkir?kurir=${country}&apikey=${config.vhtear}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})

/**
 * Get jadwal bola data.
 * @returns {Promise<object>}
 */
const bola = () => new Promise((resolve, reject) => {
    console.log('Searching for jadwal bola...')
 ...
 * @returns {Promise<object>}
 */
const spamsms = (number) => new Promise((resolve, reject) => {
    console.log(`Sending SMS to ${number}`)
    fetchJson(`https://lolhuman.herokuapp.com/api/sms/spam4?apikey=${config.lol}&nomor=${number}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
